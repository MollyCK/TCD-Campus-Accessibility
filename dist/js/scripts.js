function openModal() { 
	$("area").each(function(i){ 
		$(this).click(function(e){
			...
			var id = $(this).attr("id"); 
			$.ajax({
			  	url: "data/dataExample.json?id="+id,	//Needs to be replaced with server url 
			  	dataType:"json"
...
function myfunct(){
	...
	$.ajax({
		...
		dataType:"json",
		//data: scores, --- this is for when it's connected to server. You can ignore or delete this line
	}).done(function(data){
